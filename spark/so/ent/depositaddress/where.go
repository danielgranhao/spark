...
func NetworkEQ(v btcnetwork.Network) predicate.DepositAddress {
	return predicate.DepositAddress(sql.FieldEQ(FieldNetwork, v))
}

// NetworkNEQ applies the NEQ predicate on the "network" field.
func NetworkNEQ(v btcnetwork.Network) predicate.DepositAddress {
	return predicate.DepositAddress(sql.FieldNEQ(FieldNetwork, v))
}

// NetworkIn applies the In predicate on the "network" field.
func NetworkIn(vs ...btcnetwork.Network) predicate.DepositAddress {
	return predicate.DepositAddress(sql.FieldIn(FieldNetwork, vs...))
}

// NetworkNotIn applies the NotIn predicate on the "network" field.
func NetworkNotIn(vs ...btcnetwork.Network) predicate.DepositAddress {
	return predicate.DepositAddress(sql.FieldNotIn(FieldNetwork, vs...))
}
