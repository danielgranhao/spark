...
func (Tree) Fields() []ent.Field {
	return []ent.Field{
		field.Bytes("owner_identity_pubkey").
			GoType(keys.Public{}).
			Comment("The identity public key of the user who owns this tree.").
			Annotations(entexample.Default("028c094a432d46a0ac95349d792c2e3730bd60c29188db716f56a99e39b95338b4")),
		field.Enum("status").
			GoType(st.TreeStatus("")).
			Comment("Current lifecycle status of the tree (e.g., AVAILABLE, EXITING).").
		...
		field.Bytes("base_txid").
			GoType(st.TxID{}).
			Comment("The transaction ID of the L1 UTXO that anchors this tree.").
			Annotations(entexample.Default("bb736bfae9b0a47584bbdbb27606eedef1b5bb3927d692f339909863c22e27d2")),
		field.Int16("vout").
			NonNegative().
			Comment("The output index within the base transaction that anchors this tree.").
